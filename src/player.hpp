...
struct Player 
{
    ...
    Player(const int x, const int y): pos_x(x), pos_y(y), health(100) {}
    explicit Player(const int h): pos_x(0), pos_y(0), health(h) {}
    explicit Player(const std::vector<InventoryItem> &inv): pos_x(0), pos_y(0), health(100), inventory(inv) {}
